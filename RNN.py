...
class RNN(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # Decoder LSTM
        self.RNN = nn.RNN(input_size=cfg['embedding_size'], hidden_size=cfg['hidden_size'],
                            num_layers=cfg['num_layers'], batch_first=True,
                            dropout=cfg['dropout'], bidirectional=cfg['bidirectional'])
        
        self.RNN_out = nn.Linear(cfg['hidden_size'], cfg['vocab_size'])
        self.RNN_batch_norm = nn.BatchNorm1d(cfg['hidden_size'])
